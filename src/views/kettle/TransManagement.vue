  ...
  <a-card :bordered="false">
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="48">
          <a-col :md="6" :sm="24">
            <a-form-item label="转换名称">
              <a-input v-model="queryParam.name" style="width: 100%" placeholder="请输入转换名称"/>
            </a-form-item>
          </a-col>
  ...
  data () {
    return {
      ...
      loadData: parameter => {
        ...
        return kettleTransPageList(Object.assign(parameter, this.queryParam))
          .then(res => {
            return res
          })
      },
